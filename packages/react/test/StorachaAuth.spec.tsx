...
import { Provider, StorachaAuth, useStorachaAuth } from '../src/index.js'
...
describe('StorachaAuth Component Suite', () => {
      ...
      const TestComponent = () => {
        ...
        return (
          <div>
            ...
            <div data-testid="submitted">{auth.submitted.toString()}</div>
            <button onClick={() => auth.setEmail('test@example.com')}>Set Email</button>
          </div>
        )
      }
  ...
  describe('useStorachaAuth hook', () => {
    test('provides authentication functionality', () => {
      const TestComponent = () => {
        const auth = useStorachaAuth()
        return (
          <div>
  ...
  describe('Integration Tests', () => {
    ...
    test('iframe detection works correctly', () => {
      const TestComponent = () => {
        const auth = useStorachaAuth()
        return <div data-testid="is-iframe">{auth.isIframe.toString()}</div>
      }
