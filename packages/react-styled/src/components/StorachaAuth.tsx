...
import { storachaLogoUrl, rachaFireBgUrl } from '../assets/index.js'
...
export const StorachaAuthForm = () => {
  return (
    <div 
      ...
      style={{
        background: `#EFE3F3 url(${rachaFireBgUrl}) bottom left`,
    ...
    >
      <HeadlessStorachaAuth.Form className='storacha-auth-form'>
        <div className='storacha-auth-logo-container'>
          <img src={storachaLogoUrl} alt="Storacha" className='storacha-auth-logo' />
        </div>
        <div>
